defmodule LearnAbsintheWeb.SubscriptionCase do
  ...
  using do
    quote do
      use LearnAbsintheWeb.ChannelCase
      use Absinthe.Phoenix.SubscriptionTest, schema: LearnAbsintheWeb.Schema

      import LearnAbsintheWeb.GraphQlHelpers

      defp create_socket(params \\ %{}) do
        {:ok, socket} = ChannelTest.connect(LearnAbsintheWeb.UserSocket, params)
